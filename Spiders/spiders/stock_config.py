...
SIGNAL_FILTERS = {
    ...
    'signal_quality': {
        'min_history_occurrences_exclusive': 5,  # total > 此值（即至少7次）；兼顾样本充分性与 quiet day 产出
        'min_signal_success_rate': 56.0,         # 单信号类型历史胜率门槛
        'min_overall_success_rate': 56.0,        # 所有信号类型综合胜率门槛
